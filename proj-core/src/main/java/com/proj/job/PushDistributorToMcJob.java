 ...
 * 分销商-基础数据-接口对接(美驰)
 */
public class PushDistributorToMcJob extends AbstractJob {

    private static transient final Logger logger = LoggerFactory.getLogger(PushDistributorToMcJob.class);
