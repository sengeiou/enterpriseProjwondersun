 ...
 */
@Controller
@RequestMapping("/api/proj/referencetarget")
public class ReferenceTargetApi extends BaseController {
    @Resource
    ...
    public Object add(SimpleTypeDTO simpleTypeDTO) {
        ...
        if (apiResult.getData() == null) {
            ...
            simpleTypeDTO1.setId("REFERENCETARGET");
            ...
            simpleTypeDTO1.setCode("REFERENCETARGET");
            simpleTypeDTO1.setName("参数指标");
        ...
        simpleTypeDTO.setId("REFERENCETARGET_" + simpleTypeDTO.getCode());
