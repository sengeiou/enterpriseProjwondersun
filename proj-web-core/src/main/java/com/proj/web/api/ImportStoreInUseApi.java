 ...
 */
@Controller
@RequestMapping("/api/proj/importStoreInUse")
public class ImportStoreInUseApi extends BaseController {

    private static Logger logger = LoggerFactory.getLogger(ImportStoreInUseApi.class);

    @Resource
    private ImportStoreInUseService imoportStoreInUseService;
    ...
    public APIResult<String> importExcel(@RequestParam MultipartFile file) throws JsonProcessingException {
        ...
        try {
            ...
            result =imoportStoreInUseService.importExcel(rowList,getCurrentUser());
            return result;
        }catch (Exception e){
            e.printStackTrace();
