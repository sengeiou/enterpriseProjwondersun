 ...
 */
@Controller
@RequestMapping("/api/proj/dealertype")
public class DealerTypeApi extends BaseController {
    @Resource
    ...
    public Object add(SimpleTypeDTO simpleTypeDTO) {
        ...
        if (apiResult.getData() == null) {
            ...
            simpleTypeDTO1.setId("DEALERTYPE");
            ...
            simpleTypeDTO1.setCode("DEALERTYPE");
            simpleTypeDTO1.setName("经销商类型");
        ...
        simpleTypeDTO.setId("DEALERTYPE_" + simpleTypeDTO.getCode());
    ...
    @RequestMapping(value = {"changeOrganizationInUse"}, method = {RequestMethod.POST})
    @ResponseBody
    public Object changeOrganizationInUse(int type, @RequestParam("ids") String[] ids) {
        APIResult<String> mes = new APIResult<>();
        int k = 0;
        ...
        if (ids == null) {
            ...
            for (String id : ids) {
                APIResult<String> result = dealerD2RelationAppService.changeOrganizationInUse(type, id,userName);
                if (result.getCode() != 0) {
                    mes = result;
                    k++;
                }
